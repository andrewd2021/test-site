                            ...
                            <div class="count-item">
                                <div class="count-inner">
                                    ...
                                    <div class="count-content">
                                        <h2><span class="count" data-to="<?php echo $stat_number; ?>" data-speed="1500"></span><span>+</span></h2>
                                ...
                                <div class="event-inner">
                                    ...
                                    <div class="event-content">
                                        ...
                                        <div class="event-content-info">
                                            <a href="#"><h4><?php the_field('h_event_title'); ?></h4></a>
                                            <ul class="lab-ul">
                            ...
                            <div class="event-item">
                                <div class="event-inner">
                                    <div class="event-content">
                                        ...
                                        <div class="event-content-info">
                                            <a href="#"><h5><?php echo $e_title; ?></h5></a>
                                            <ul class="lab-ul">
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item">
                                <div class="gallery-inner">
                                    <img src="<?php echo $g_image; ?>" alt="education">
                                </div>
                            </div>
                        </div>
                        <?php endwhile; endif; ?>
